...
@Bind(R.id.password_confirmation) EditText mPasswordConfirmationView;
@Bind(R.id.login_form) View mLoginFormView;
@Bind(R.id.info_text) TextView mInfoText;
@Bind(R.id.progress_circular) ProgressBar mLoading;

private SharedPreferences prefs;

@OnClick(R.id.email_sign_in) void signInButton() {
...
@OnClick(R.id.email_register) void registerButton() {
    mEmailView.setError(null);
    mPasswordView.setError(null);
